 ...
 */
final class Version20230528062354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_detail ADD price INT DEFAULT NULL, CHANGE fullnameuser fullnameuser VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE status status TINYINT(1) DEFAULT NULL, CHANGE stripesession stripesession VARCHAR(255) DEFAULT NULL');
    }
